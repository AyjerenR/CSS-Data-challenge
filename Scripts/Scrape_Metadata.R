...
load("../Data/stable_urls_18.Rdata") #loading vector of stable URLs from nth leg
...
metadata_df18$Static_URL[1]

save(metadata_df18, file="../Data/18leg_metadata_df_new.Rdata")
